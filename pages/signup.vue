  ...
  <div class="screen-container">
    <div class="right-side">
      <Form
        ...
        v-slot="{ errors }"
      >
        <h1 class="welcome">Get Started With</h1>
        <h1 class="welcome">Application</h1>
        <p class="sub-text">
          Join the Restaurant Dashboard Revolution and Unlock Your Restaurant's
          Full Potential
        </p>
        <div class="naming-row">
          <div>
            ...
            <div
              class="input-div"
              :class="{ '!border-red-500 !mb-0': errors.firstName }"
            >
              <Field
                type="text"
                class="signup-input !w-[250px]"
          ...
          <div>
            ...
            <div
              class="input-div"
              :class="{ '!border-red-500 !mb-0': errors.lastName }"
            >
              <Field
                type="text"
                class="signup-input !w-[250px]"
        ...
        <div
          class="input-div"
          :class="{ '!border-red-500 !mb-0': errors.phone }"
        >
          <Field
            type="text"
            class="signup-input"
        ...
        <ErrorMessage class="text-sm text-red-600 capitalize" name="phone" />
        ...
        <div class="flex justify-between my-3 items-center">
          <label class="text-sm cursor-pointer" for="myCheckbox">
            ...
            <span class="ml-2 text-gray-700 font-primary dark:text-white"
              >I want to receive promotional messages from the app</span
            >
          </label>
        </div>

        <button class="signup-btn">Signup</button>
        <div class="flex justify-center gap-1 mt-7">
          <p class="text-zinc-600 font-primary font-normal text-sm">
...
<style scoped>
.screen-container {
  @apply h-screen md:flex bg-slate-100 overflow-hidden;
}

.logo {
  @apply relative bottom-[100px];
}
...
.right-side {
  @apply flex md:w-1/2 justify-center py-10 items-center  dark:bg-primary bg-slate-100 overflow-auto;
}
...
.form-section {
  ...
  @apply w-[100%] bg-slate-100 dark:bg-primary;
}
...
.sub-text {
  @apply mb-[25px] text-lg font-semibold text-left mt-2 font-primary text-[#6E7A84];
}

.label {
  @apply font-primary text-[#93A3B0] text-base my-1 font-medium;
}
...
@media (max-width: 1670px) {
  .logo {
    @apply relative bottom-[50px];
  }
}

@media (max-width: 1370px) {
  .logo {
    @apply relative bottom-[10px];
  }
  .form-section {
    margin-top: 295px;
  }
