...
<template>
  <div class="h-screen md:flex bg-[#F5F6FA]">
    <div class="right-side">
      ...
      >
        ...
        <p class="label !mt-10">Password</p>
        <div
          class="input_div relative"
        ...
        <p class="label">Confirmation password</p>
        <div
          class="input_div relative"
          :class="{ '!border-red-500 !mb-0': errors.confirmPassword }"
        >
          <Field
            class="reset-input"
            type="password"
...
.circle-top {
  @apply absolute right-0 w-[278px] -top-[80px];
}
...
.right-side {
  @apply flex md:w-1/2 justify-center py-10 items-center bg-[#F5F6FA];
}
...
.form-section {
  ...
  @apply w-[100%] bg-[#F5F6FA];
}

.welcome {
  @apply font-primary text-center font-black text-5xl w-max;
}
...
.save-btn {
  @apply font-primary  text-lg flex w-full bg-primary mt-10 py-2 rounded-[10px] text-white font-semibold items-center h-12 justify-center gap-7;
}
